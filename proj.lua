...
files {
  ...
  -- "build/src/file_embed/proj_db.c",
  -- "build/src/file_embed/proj_ini.c",
  -- "build/src/file_embed/world.c",
  -- "build/src/file_embed/other_extra.c",
  -- "build/src/file_embed/nad27.c",
  -- "build/src/file_embed/GL27.c",
  -- "build/src/file_embed/nad83.c",
  -- "build/src/file_embed/nad_lst.c",
  -- "build/src/file_embed/CH.c",
  -- "build/src/file_embed/ITRF2000.c",
  -- "build/src/file_embed/ITRF2008.c",
  -- "build/src/file_embed/ITRF2014.c",
  -- "build/src/file_embed/ITRF2020.c",
